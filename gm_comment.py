...
with open("gm_comment.csv", "w") as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(["comment"])
for i in range(1,3):
    time.sleep(random.randint(10,15))
    print(i)
    url="https://ss.gome.com.cn/item/v1/prdevajsonp/appraiseNew/9115818777/"+str(i)+"/bad/1/1557/flag/appraise"
    ...
    for comment in comments:
        ...
        print(comment_text)
        with open("gm_comment.csv", "a") as csvfile:
            writer = csv.writer(csvfile)
